const TestimonialPage = () => {
    return ( 
        <>
        <section className="w-full py-20 bg-[#1B2E45] text-[#DCD7C9]">
        <div className="max-w-6xl mx-auto px-6 text-center">
            <h2 className="text-3xl mb-10 font-bold">What's our user say</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#23486A] p-6 rounded-xl shadow-md hover:scale-105 transition-transform">
